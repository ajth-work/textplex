...
| Restore reliable horizontal reader navigation and drag behavior | #91 | In progress. Dan tester feedback; scope horizontal wheel/drag behavior to the session-detail and sentence/page/book visual-progress carousels, preserving vertical scrolling and keyboard/touch fallbacks. Inventory IDs: `reader.session-summary-details`, `reader.progress-carousel`, `reader.progress-card`. Labels: `feedback`, `feedback:needs-review`, `feedback:reader`, `bug`. |
