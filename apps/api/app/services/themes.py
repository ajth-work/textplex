...
STATIC_THEMES = [
    ...
    {"id": "fruit-strawberry-night", "title": "Strawberry — Night", "description": "Deep berry canvas, dusky blossoms, and warm strawberry highlights for evening reading.", "price_cents": 199, "is_free": False},
    ...
    {"id": "city-hong-kong-daylight", "title": "Hong Kong — Daylight", "description": "Harbor water, hillside contours, ferries, and vertical city geometry inspired by Hong Kong.", "price_cents": 199, "is_free": False},
    {"id": "city-hong-kong-night", "title": "Hong Kong — Night", "description": "Deep harbor blue, reflected tower lights, ferries, and hillside city glow inspired by Hong Kong after dark.", "price_cents": 199, "is_free": False},
