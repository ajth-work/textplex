...
def fetch_random_article(language_code: str) -> WikipediaArticle:
    ...
    if not isinstance(title, str) or not title.strip() or not text:
        raise WikipediaImportError("Wikipedia returned an article without readable text. Please try again.")
